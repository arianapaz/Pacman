...
from gym_pacman.envs.graphicsDisplay import PacmanGraphics, DEFAULT_GRID_SIZE
from gym_pacman.envs.pacman import ClassicGameRules
from gym_pacman.envs.layout import getLayout, getRandomLayout
...
class PacmanEnv(gym.Env):
    ...
    def step(self, action):
        ...
        self.step_counter += 1
        info = {
            'illegal_action': self.game.state.getLegalPacmanActions,
